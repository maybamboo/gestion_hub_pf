		...
		<transmission>
			...
			<xsl:variable name="CODE">
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:value-of select="/request-context/services-responses/indicadores-hora/obtener-empresa/response/data/Results/Row/DOC_EMP" disable-output-escaping="yes"/>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>

			<data>				
				CALL PKG_GESTION.CONSULTAR_INDICADORES_HORA(
